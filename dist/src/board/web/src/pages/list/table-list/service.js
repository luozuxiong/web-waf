...
exports.updateRule = exports.addRule = exports.removeRule = exports.queryRule = void 0;
var umi_request_1 = __importDefault(require("umi-request"));
function queryRule(params) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, umi_request_1.default('/api/rule', {
                    params: params,
                })];
        });
    });
...
function removeRule(params) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, umi_request_1.default('/api/rule', {
                    method: 'POST',
                    data: __assign(__assign({}, params), { method: 'delete' }),
                })];
        });
    });
}
...
function updateRule(params) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, umi_request_1.default('/api/rule', {
                    method: 'POST',
                    data: __assign(__assign({}, params), { method: 'update' }),
                })];
        });
    });
}
