...
exports.setAuthority = exports.getPageQuery = void 0;
var umi_1 = require("umi");
var antd_1 = require("antd");
var qs_1 = require("qs");
var service_1 = require("./service");
function getPageQuery() {
    return qs_1.parse(window.location.href.split('?')[1]);
}
    ...
    effects: {
        login: function (_a, _b) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, call(service_1.fakeAccountLogin, payload)];
                    case 1:
                        response = _c.sent();
                        return [4 /*yield*/, put({
        ...
        getCaptcha: function (_a, _b) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, call(service_1.getFakeCaptcha, payload)];
                    case 1:
                        _c.sent();
                        return [2 /*return*/];
                }
