...
var Model = {
    ...
    effects: {
        fetch: function (_, _a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, call(service_1.query)];
                    case 1:
                        response = _b.sent();
                        return [4 /*yield*/, put({
                                type: 'save',
        ...
        fetchProvince: function (_, _a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        return [4 /*yield*/, call(service_1.queryProvince)];
                    case 2:
                        response = _b.sent();
                        return [4 /*yield*/, put({
                                type: 'setProvince',
        ...
        fetchCity: function (_a, _b) {
            var response;
            var payload = _a.payload;
            var call = _b.call, put = _b.put;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, call(service_1.queryCity, payload)];
                    case 1:
                        response = _c.sent();
                        return [4 /*yield*/, put({
                                type: 'setCity',
    ...
    reducers: {
        ...
        setProvince: function (state, action) {
            return __assign(__assign({}, state), { province: action.payload });
        },
