...
var TableList = function () {
    ...
    var _d = react_1.useState([]), selectedRowsState = _d[0], setSelectedRows = _d[1];
    var columns = [
        {
            title: '规则名称',
            dataIndex: 'name',
    ...
    return (<pro_layout_1.PageContainer>
      <pro_table_1.default headerTitle="查询表格" actionRef={actionRef} rowKey="key" toolBarRender={function () { return [
        ...
        onChange: function (_, selectedRows) { return setSelectedRows(selectedRows); },
    }}/>
      {(selectedRowsState === null || selectedRowsState === void 0 ? void 0 : selectedRowsState.length) > 0 && (<pro_layout_1.FooterToolbar extra={<div>
              已选择 <a style={{ fontWeight: 600 }}>{selectedRowsState.length}</a> 项&nbsp;&nbsp;
              <span>
                服务调用次数总计 {selectedRowsState.reduce(function (pre, item) { return pre + item.callNo; }, 0)} 万
              </span>
            </div>}>
          <antd_1.Button onClick={function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    setSelectedRows([]);
                    (_a = actionRef.current) === null || _a === void 0 ? void 0 : _a.reloadAndRest();
                    return [2 /*return*/];
            }
        });
    }); }}>
